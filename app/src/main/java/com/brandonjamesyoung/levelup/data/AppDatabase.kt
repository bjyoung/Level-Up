        ...
        private class AppDatabaseCallback(val context: Context) : Callback() {
            ...
            private suspend fun initializeIcons(iconDao: IconDao) {
                val iconFileNameTriples = listOf(
                    Triple("Archive", R.drawable.archive_icon, IconGroup.SPADES),
                    ...
                    Triple("Building", R.drawable.building_icon, IconGroup.SPADES),
                    ...
                    Triple("Clock", R.drawable.clock_icon, IconGroup.SPADES),
                    ...
                    Triple("Desk", R.drawable.desk_icon, IconGroup.DIAMONDS),
                    Triple("Diamond", R.drawable.diamond_icon, IconGroup.DIAMONDS),
                    Triple("Direction Signs", R.drawable.direction_signs_icon, IconGroup.DIAMONDS),
                    ...
                    Triple("Fast Forward", R.drawable.fast_forward_icon, IconGroup.HEARTS),
                    Triple("File", R.drawable.file_icon, IconGroup.HEARTS),
                    Triple("Film", R.drawable.film_icon, IconGroup.HEARTS),
                    Triple("Fish", R.drawable.fish_icon, IconGroup.HEARTS),
                    ...
                    Triple("Map Marker", R.drawable.map_marker_icon, IconGroup.HEARTS),
                    Triple("Martini Glass", R.drawable.martini_glass_icon, IconGroup.HEARTS),
                    Triple("Play", R.drawable.play_icon, IconGroup.HEARTS),
                    Triple("Power", R.drawable.power_button_icon, IconGroup.HEARTS),
                    Triple("Road", R.drawable.road_icon, IconGroup.HEARTS),
                    Triple("Save", R.drawable.save_icon, IconGroup.HEARTS),
                    Triple("Storage", R.drawable.storage_icon, IconGroup.HEARTS),
                    Triple("Terminal", R.drawable.terminal_icon, IconGroup.HEARTS),

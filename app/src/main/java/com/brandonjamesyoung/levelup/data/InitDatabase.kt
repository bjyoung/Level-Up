...
class InitDatabase {
    ...
    private fun getInitIconData() : List<Triple<String, Int, IconGroup>> {
        return listOf(
            ...
            Triple("Audio", R.drawable.audio_icon, IconGroup.DIAMONDS),
            ...
            Triple("Bell", R.drawable.bell_icon, IconGroup.HEARTS),
            ...
            Triple("Bookshelf", R.drawable.bookshelf_icon, IconGroup.HEARTS),
            Triple("Bow", R.drawable.bow_and_arrow_icon, IconGroup.CLUBS),
            Triple("Bubble", R.drawable.bubble_icon, IconGroup.CLUBS),
            ...
            Triple("Clover", R.drawable.clover_icon, IconGroup.CLUBS),
            ...
            Triple("Crown", R.drawable.crown_icon, IconGroup.CLUBS),
            ...
            Triple("Disc", R.drawable.disc_icon, IconGroup.DIAMONDS),
            ...
            Triple("Fan", R.drawable.fan_icon, IconGroup.HEARTS),
            ...
            Triple("Grid", R.drawable.grid_icon, IconGroup.SPADES),
            Triple("Group", R.drawable.group_icon, IconGroup.SPADES),
            Triple("Hand", R.drawable.hand_icon, IconGroup.HEARTS),
            ...
            Triple("Link", R.drawable.link_icon, IconGroup.SPADES),
            ...
            Triple("Mouse", R.drawable.mouse_icon, IconGroup.SPADES),
            Triple("Move", R.drawable.move_icon, IconGroup.SPADES),
            ...
            Triple("Paint Bucket", R.drawable.paint_bucket_icon, IconGroup.DIAMONDS),
            Triple("Pawn", R.drawable.pawn_icon, IconGroup.DIAMONDS),
            Triple("Paw Print", R.drawable.paw_print_icon, IconGroup.HEARTS),
            Triple("Pickaxe", R.drawable.pickaxe_icon, IconGroup.SPADES),
            ...
            Triple("Stamp", R.drawable.stamp_icon, IconGroup.HEARTS),
            Triple("Storage", R.drawable.storage_icon, IconGroup.HEARTS),
            Triple("Store", R.drawable.store_icon, IconGroup.CLUBS),
            ...
            Triple("Tag", R.drawable.tag_icon, IconGroup.SPADES),
            ...
            Triple("Undo", R.drawable.undo_icon, IconGroup.SPADES),
